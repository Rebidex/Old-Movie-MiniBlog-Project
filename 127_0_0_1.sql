...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2023 at 09:04 PM
...
(1, 'atestat', 'Filme', 'nume', '', '', '_', ''),
(2, 'atestat', 'Filme', 'email', '', '', '_', ''),
(3, 'atestat', 'Filme', 'film', '', '', '_', ''),
(4, 'atestat', 'Filme', 'gen', '', '', '_', ''),
(5, 'atestat', 'Filme', 'snacks', '', '', '_', '');
...
('root', '[{"db":"atestat","table":"filme"},{"db":"atestat","table":"Filme"},{"db":"domnitor","table":"DOMNITOR"}]');
...
('root', '2023-05-13 10:06:04', '{"Server\\/hide_db":"","collation_connection":"utf8mb4_general_ci"}');
